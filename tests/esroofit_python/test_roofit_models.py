...
from esroofit.roofit_models import RooFitModel, TruncExponential


class RooFitModelTest(unittest.TestCase):
    """Tests for RooFit-model base class"""

    @mock.patch('esroofit.roofit_utils.load_libesroofit')
...
class TruncExponentialTest(unittest.TestCase):
    ...
    @mock.patch('esroofit.roofit_models.RooFitModel.__init__')
    @mock.patch('esroofit.roofit_models.super')
